...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    public static DateTimeFormatter YYYY_MM_DD_HH_MM_SS_SSS =
        DateTimeFormatter.ofPattern(PATTERN_YYYY_MM_DD_HH_MM_SS_SSS).withZone(ZONE);

    public static DateTimeFormatter YYYY_MM_DD_HH_MM_SS =
        DateTimeFormatter.ofPattern(PATTERN_YYYY_MM_DD_HH_MM_SS).withZone(ZONE);
    ...
    public static long between(LocalDate source, LocalDate target, TimeUnit timeUnit) {
        ...
        return doBetween(localDateToLocalDateTimeConverter(source), localDateToLocalDateTimeConverter(target),
            timeUnit);
    }
    ...
    public static long between(LocalTime source, LocalTime target, TimeUnit timeUnit) {
        ...
        return doBetween(localTimeToLocalDateTimeConverter(source), localTimeToLocalDateTimeConverter(target),
            timeUnit);
    }
